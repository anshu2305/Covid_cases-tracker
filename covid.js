...
setInterval( () => {
    fetch("https://corona.lmao.ninja/v2/countries/India")
        ...
        document.getElementById("casespm").innerHTML=data.casesPerOneMillion.toLocaleString();
        document.getElementById("deathspm").innerHTML=data.deathsPerOneMillion.toLocaleString();
        document.getElementById("recpm").innerHTML=data.recoveredPerOneMillion.toLocaleString();
        document.getElementById("testspm").innerHTML=data.testsPerOneMillion.toLocaleString();
        document.getElementById("critipm").innerHTML=data.criticalPerOneMillion.toLocaleString();
        document.getElementById("activepm").innerHTML=data.activePerOneMillion.toLocaleString();
        })
        ...
        //console.log(data);
        notresponding();
        document.getElementById("todaycases").innerHTML=data.statewise[0].deltaconfirmed.toLocaleString();
        document.getElementById("todaydeaths").innerHTML=data.statewise[0].deltadeaths.toLocaleString();
        document.getElementById("todayrec").innerHTML=data.statewise[0].deltarecovered.toLocaleString();
        document.getElementById("time").innerHTML=data.statewise[0].lastupdatedtime.toLocaleString();

        document.getElementById("state-namet1").innerHTML=data.statewise[1].state.toLocaleString();
        document.getElementById("dtotalt1").innerHTML=data.statewise[1].deltaconfirmed.toLocaleString();
        document.getElementById("Totalt1").innerHTML=data.statewise[1].confirmed.toLocaleString();
        //newarr[1]=parseInt("num[1]");   
        document.getElementById("Activet1").innerHTML=data.statewise[1].active.toLocaleString();
        document.getElementById("drect1").innerHTML=data.statewise[1].deltarecovered.toLocaleString();
        document.getElementById("Recoveredt1").innerHTML=data.statewise[1].recovered.toLocaleString();
        document.getElementById("ddead1").innerHTML=data.statewise[1].deltadeaths.toLocaleString();
        document.getElementById("Deceasedt1").innerHTML=data.statewise[1].deaths.toLocaleString();


        //console.log(typeof newarr[1]);

        document.getElementById("state-namet2").innerHTML=data.statewise[2].state.toLocaleString();
        document.getElementById("dtotalt2").innerHTML=data.statewise[2].deltaconfirmed.toLocaleString();
        document.getElementById("Totalt2").innerHTML=data.statewise[2].confirmed.toLocaleString();
        document.getElementById("Activet2").innerHTML=data.statewise[2].active.toLocaleString();
        document.getElementById("drect2").innerHTML=data.statewise[2].deltarecovered.toLocaleString();
        document.getElementById("Recoveredt2").innerHTML=data.statewise[2].recovered.toLocaleString();
        document.getElementById("ddead2").innerHTML=data.statewise[2].deltadeaths.toLocaleString();
        document.getElementById("Deceasedt2").innerHTML=data.statewise[2].deaths.toLocaleString();

        document.getElementById("state-namet3").innerHTML=data.statewise[3].state.toLocaleString();
        document.getElementById("dtotalt3").innerHTML=data.statewise[3].deltaconfirmed.toLocaleString();
        document.getElementById("Totalt3").innerHTML=data.statewise[3].confirmed.toLocaleString();
        document.getElementById("Activet3").innerHTML=data.statewise[3].active.toLocaleString();
        document.getElementById("drect3").innerHTML=data.statewise[3].deltarecovered.toLocaleString();
        document.getElementById("Recoveredt3").innerHTML=data.statewise[3].recovered.toLocaleString();
        document.getElementById("ddead3").innerHTML=data.statewise[3].deltadeaths.toLocaleString();
        document.getElementById("Deceasedt3").innerHTML=data.statewise[3].deaths.toLocaleString();

        document.getElementById("state-namet4").innerHTML=data.statewise[4].state.toLocaleString();
        document.getElementById("dtotalt4").innerHTML=data.statewise[4].deltaconfirmed.toLocaleString();
        document.getElementById("Totalt4").innerHTML=data.statewise[4].confirmed.toLocaleString();
        document.getElementById("Activet4").innerHTML=data.statewise[4].active.toLocaleString();
        document.getElementById("drect4").innerHTML=data.statewise[4].deltarecovered.toLocaleString();
        document.getElementById("Recoveredt4").innerHTML=data.statewise[4].recovered.toLocaleString();
        document.getElementById("ddead4").innerHTML=data.statewise[4].deltadeaths.toLocaleString();
        document.getElementById("Deceasedt4").innerHTML=data.statewise[4].deaths.toLocaleString();
